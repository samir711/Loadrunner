# 1 "d:\\loadrunnerscripts\\day28_fileuploading\\\\combined_Day28_FileUploading.c"
...
# 1 "d:\\loadrunnerscripts\\day28_fileuploading\\\\combined_Day28_FileUploading.c" 2
...
# 2 "d:\\loadrunnerscripts\\day28_fileuploading\\\\combined_Day28_FileUploading.c" 2
...
# 3 "d:\\loadrunnerscripts\\day28_fileuploading\\\\combined_Day28_FileUploading.c" 2
...
# 4 "d:\\loadrunnerscripts\\day28_fileuploading\\\\combined_Day28_FileUploading.c" 2
...
Action()
{
 ...
 Download_size = web_get_int_property(2);
 
 lr_output_message("%d",Download_size);
 
 if(Download_size >= 1048576)
 {
 	lr_end_transaction("T1", 0);

 }
 	
 else
 {
 	lr_end_transaction("T1", 1);
 }
	return 0;
}
# 5 "d:\\loadrunnerscripts\\day28_fileuploading\\\\combined_Day28_FileUploading.c" 2
...
# 6 "d:\\loadrunnerscripts\\day28_fileuploading\\\\combined_Day28_FileUploading.c" 2
