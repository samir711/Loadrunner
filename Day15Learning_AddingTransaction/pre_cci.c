# 1 "d:\\loadrunnerscripts\\day15learning_addingtransaction\\\\combined_Day15Learning_AddingTransaction.c"
...
# 1 "d:\\loadrunnerscripts\\day15learning_addingtransaction\\\\combined_Day15Learning_AddingTransaction.c" 2
...
# 2 "d:\\loadrunnerscripts\\day15learning_addingtransaction\\\\combined_Day15Learning_AddingTransaction.c" 2
...
# 3 "d:\\loadrunnerscripts\\day15learning_addingtransaction\\\\combined_Day15Learning_AddingTransaction.c" 2
...
# 4 "d:\\loadrunnerscripts\\day15learning_addingtransaction\\\\combined_Day15Learning_AddingTransaction.c" 2
...
Login()
{
	...
	lr_end_transaction("LaunchTransaction",2);
	...
	web_submit_data("login.pl_2", 
		...
		"LAST");
lr_end_transaction("LoginTransaction", 2);

	return 0;
}
# 5 "d:\\loadrunnerscripts\\day15learning_addingtransaction\\\\combined_Day15Learning_AddingTransaction.c" 2
...
BookingFlight()
{
	...
	lr_start_transaction("ClickOnFlight");

	web_url("welcome.pl_9", 
		...
		"Mode=HTML", 
		"LAST");
	lr_end_transaction("ClickOnFlight",2);

	 

	lr_think_time(14);
	
	lr_start_transaction("FlightOptions");
	...
	lr_end_transaction("FlightOptions",2);
	...
	web_submit_data("reservations.pl_13", 
		"Action=http://127.0.0.1:1080/cgi-bin/reservations.pl", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=text/html", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=outboundFlight", "Value=011;343;11/25/2018", "ENDITEM", 
		"Name=numPassengers", "Value=1", "ENDITEM", 
		"Name=advanceDiscount", "Value=0", "ENDITEM", 
		"Name=seatType", "Value=Coach", "ENDITEM", 
		"Name=seatPref", "Value=None", "ENDITEM", 
	...
	web_submit_data("reservations.pl_14", 
		"Action=http://127.0.0.1:1080/cgi-bin/reservations.pl", 
		"Method=POST", 
		"TargetFrame=", 
		"RecContentType=text/html", 
		...
		"Name=address1", "Value=HIG 46 SECTOR A  SONAGIRI", "ENDITEM", 
		"Name=address2", "Value=BHOPAL MP 462021", "ENDITEM", 
...
# 6 "d:\\loadrunnerscripts\\day15learning_addingtransaction\\\\combined_Day15Learning_AddingTransaction.c" 2
...
# 7 "d:\\loadrunnerscripts\\day15learning_addingtransaction\\\\combined_Day15Learning_AddingTransaction.c" 2
...
# 8 "d:\\loadrunnerscripts\\day15learning_addingtransaction\\\\combined_Day15Learning_AddingTransaction.c" 2
...
# 9 "d:\\loadrunnerscripts\\day15learning_addingtransaction\\\\combined_Day15Learning_AddingTransaction.c" 2
